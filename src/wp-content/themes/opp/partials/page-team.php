				...
				<div class="thumbnail thumbnail-horizontal clearfix">
			  		<div class="image">
			  			<?php if ( $founderThumbnail ) : ?>
			  				<img src="<?php echo $founderThumbnail['sizes']['medium']; ?>" alt="<?php echo $founder->post_title; ?>" />
			  			<?php else : ?>
			  				<img src="<?php bloginfo('template_directory'); ?>/img/default/photo.png" alt="<?php echo $founder->post_title; ?>" />
			  			<?php endif; ?>
			  		</div>
			      	<div class="caption">
